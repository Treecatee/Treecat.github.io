...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-e435bb","is-html-e435bb","is-jsdelivr-e435bb","is-gtm-e435bb","is-gravatar-e435bb","is-theme-e435bb","is-json-e435bb"];
      return Promise.all(
        names
