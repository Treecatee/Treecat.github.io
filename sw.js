...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-aa262e","is-html-aa262e","is-jsdelivr-aa262e","is-gtm-aa262e","is-gravatar-aa262e","is-theme-aa262e","is-json-aa262e"];
      return Promise.all(
        names
