...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-64dfac","is-html-64dfac","is-jsdelivr-64dfac","is-gtm-64dfac","is-gravatar-64dfac","is-theme-64dfac","is-json-64dfac"];
      return Promise.all(
        names
